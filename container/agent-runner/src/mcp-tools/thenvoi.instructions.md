...
Use `band_get_participants` when participant context matters. `band_add_participant`, `band_remove_participant`, and `band_create_chatroom` are blocked in the main control room; use an ordinary Band room for participant mutations.
