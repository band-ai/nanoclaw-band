...
| [docs/channel-container-config-divergence.md](docs/channel-container-config-divergence.md) | Fork vs upstream channel container-config seam — the duplicate `getChannelContainerConfig`, capability gap, consolidation options |
